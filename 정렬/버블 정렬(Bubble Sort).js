...
let arr = Array.from({length: 30000}, () => Math.floor(Math.random() * 1000)); // 1132 ms.
...
// 시간차 출력
console.log("정렬된 배열에 대한 버블 정렬 소요 시간:", endTime - startTime, "ms."); // 398 ms.