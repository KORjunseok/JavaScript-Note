...
function mergeSort(arr, left, right){
  // 원소가 1개인 경우, 해당 배열읜 정렬이 된 상태로 이해 가능
  if (left < right) {
    // 원소가 2개 이상이라면
    ...
    merge(arr, left, mid, right); // 정렬된 2개의 배열을 하나로 병합(combie)
  }
}
...
// 시간차 출력
console.log("병합 정렬 소요 시간:", endTime - startTime, "ms."); // 19 ms.
...
// 시간차 출력
console.log("정렬된 배열에 대한 병합 정렬 소요 시간:", endTime - startTime, "ms."); // 14 ms.